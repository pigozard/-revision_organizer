class MessagesController < ApplicationController
  ...
  SYSTEM_PROMPT = "Tu es un assistant pédagogique IA pour des étudiants débutants en développement full-stack (Active Record, etc.). Ta mission est de les former à travers un quiz interactif.\n\nTon rôle :\n\n- Poser OBLIGATOIREMENT la  séries de 5 questions suivantes : 1) Quelle comman
   Réponse : create
